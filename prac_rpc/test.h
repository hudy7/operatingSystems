...
#define TEST 0x21140000
#define TEST_VERSION 1

#if defined(__STDC__) || defined(__cplusplus)
#define TEST_FUNCTION 1
extern  int * test_function_1(int *, CLIENT *);
extern  int * test_function_1_svc(int *, struct svc_req *);
extern int test_1_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define TEST_FUNCTION 1
extern  int * test_function_1();
extern  int * test_function_1_svc();
